...
Visible at all times. Content in the header varies based on the user's authentication state.
...
- [ ] __20:__ See links to "Profile" and "Sign Out" when logged out.
- [ ] __20:__ See links to "Sign In" and "Sign Up" when logged in.
...
- [ ] __20:__ View "trash can" delete icons next to each review.
